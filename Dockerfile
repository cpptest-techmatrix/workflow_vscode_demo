...
#ENV CPPTEST_TEST_DIR="/opt/app/test/10.5"
...
# C++testのインストール
COPY parasoft_cpptest_professional-2021.2.1-linux.x86_64.tar.gz /opt/app

RUN chmod u+rwx /opt/app/parasoft_cpptest_professional-2021.2.1-linux.x86_64.tar.gz
RUN tar zxvf /opt/app/parasoft_cpptest_professional-2021.2.1-linux.x86_64.tar.gz && \
    rm /opt/app/parasoft_cpptest_professional-2021.2.1-linux.x86_64.tar.gz
